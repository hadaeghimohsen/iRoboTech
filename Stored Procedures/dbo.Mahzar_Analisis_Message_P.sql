...
-- =============================================
CREATE PROCEDURE [dbo].[Mahzar_Analisis_Message_P]
	@X XML,
	@XResult XML OUT
AS
BEGIN
   ...
   ELSE IF @UssdCode = '*3#'
	BEGIN
	   ...
	   BEGIN
	      SELECT @Message = N'با سلام😃🖐' + CHAR(10) + 
         N'https://telegram.me/mahzar246bot?start=' + CAST(@ChatID AS NVARCHAR(20));
	   END
